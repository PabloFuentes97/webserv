...
std::string	getPathFileRequest(bTreeNode *location, client *client, std::string &method)
//cambiar para que haga diferentes cosas segun el metodo pasado
//añadir parametro method, como string o int - hacer un enum de methods
{
	...
	//si ha encontrado la location, si es un get tiene que buscar un root o alias
	...
	//si es POST tiene que buscar el postdir 
...
//cambiar esto - cada método gestiona de manera distinta el acceso a los ficheros
{
